...
6. If you did everything correct, https://kiridev.github.io/apiKiri/ will lead to your new docs
...
- Documentation(ReDoc): https://kiridev.github.io/apiKiri/
- SwaggerUI: https://kiridev.github.io/apiKiri/swagger-ui/
- Look full spec:
    + JSON https://kiridev.github.io/apiKiri/swagger.json
    + YAML https://kiridev.github.io/apiKiri/swagger.yaml
- Preview spec version for branch `[branch]`: https://kiridev.github.io/apiKiri/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kiridev.github.io/apiKiri/ with url from the message: `Server started <url>`
